package com.yang.music.util.lrcview;
...
public class LrcView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LrcView_lrcTextSize, ScreenUtils.sp2px(12));
        mDividerHeight = ta.getDimension(R.styleable.LrcView_lrcDividerHeight, ScreenUtils.dp2px(16));
